...
<body>
	...
	<div id="dialog" title="jquery ui演示弹出层">
								...
								<form role="form" class="form-horizontal group-border">
									...
									<div class="form-group">
										...
										<div class="col-lg-4 col-md-4">
											<button class="bk-margin-5 btn btn-primary" type="button">查询账单</button>
											<button class="bk-margin-5 btn btn-success" id="addBill"
												type="button">添加账单</button>
											<button class="bk-margin-5 btn btn-success" type="button">Success</button>
										</div>
									</div>
								</form>
