											...
											<div id="message-reply" class="panel">
												<div class="panel-body message-reply">
													<div class="mailbox-compose" data-mailbox-view="compose"
														data-mailbox="">
														<h2><s:property value="%{#session.}" /></h2>
														<s:textfield cssClass="form-control" name="newNoticeName" style="height: 70px;"></s:textfield>
														<h2>正文</h2>
														<s:textarea cssClass="form-control" name="newNoticeDes" style="height: 270px;"></s:textarea>
													</div>
												</div>
											</div>
										</div>
