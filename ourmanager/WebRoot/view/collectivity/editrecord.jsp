...
<script type="text/javascript">
	...
	function del() {
	    document.getElementById("newNoticeDes").value=""; 
       document.getElementById("newNoticeName").value=""; 
	}
											...
											<div id="message-reply" class="panel">
												<div class="panel-body message-reply">
													<div class="mailbox-compose" data-mailbox-view="compose"
														data-mailbox="">
														<h2>标题</h2>
														<s:textfield cssClass="form-control" id="newNoticeName" name="newNoticeName" style="height: 70px;" value="暗室逢灯"></s:textfield>
														<h2>正文</h2>
														<s:textarea cssClass="form-control" id="newNoticeDes" name="newNoticeDes" style="height: 270px;" value="爱的方式发送的"></s:textarea>
													</div>
												</div>
											</div>
										</div>
